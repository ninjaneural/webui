...
const checkpoints = [
    ...
    },
    {
        ...
        checkpoint: 'https://civitai.com/api/download/models/86437?type=Model&format=SafeTensor&size=pruned&fp=fp16',
        checkpoint_file: 'absolutereality.safetensors',
        bakedVAE: true,
    },
    {
        name: 'CamelliaMix',
    ...
    {
        name: 'DreamShaper 6.31',
        type: '범용',
        model: 'https://civitai.com/models/4384/dreamshaper',
        ipynb: 'dreamshaper_webui_colab',
        checkpoint: 'https://huggingface.co/Lykon/DreamShaper/resolve/main/DreamShaper_6.31_BakedVae_pruned.safetensors',
        checkpoint_file: 'DreamShaper_6.31_BakedVae_pruned.safetensors',
        bakedVAE: true,
    },
    {
        name: 'expmixLine V2',
    ...
    },
    {
        ...
        checkpoint: 'https://huggingface.co/Meina/MeinaMix/resolve/main/Meina%20V10%20-%20baked%20VAE.safetensors',
        checkpoint_file: 'MeinaV10bakedVAE.safetensors',
        bakedVAE: true,
    },
    {
        name: 'MeinaPastel',
    ...
    },
    {
        ...
        type: '실사',
        model: 'https://civitai.com/models/4201?modelVersionId=114367',
        ipynb: 'realistic_vision_webui_colab',
        checkpoint: 'https://civitai.com/api/download/models/114367?type=Model&format=SafeTensor&size=pruned&fp=fp16',
        checkpoint_file: 'realisticVision_v40.safetensors',
        bakedVAE: true,
    },
    {
        name: 'ReV Animated',
...
async function make_readme() {
    let readme = [];
    readme.push(`| WebUI 3월버전(추천)                                                                                                                                                                               | WebUI 심플                                                                                                                                                                               | WebUI 최신                                                                                                                                                                                        | Deforum전용                                                                                                                                                                                      | Model                                                                                  | VAE  | Memo                    |`);
    readme.push(`| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | ---- | ----------------------- |`);
    checkpoints.forEach((item) => {

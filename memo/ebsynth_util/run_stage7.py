...
def ebsynth_utility_stage7(dbg, project_args, blend_rate,export_type,is_invert_mask,preoutput):
    dbg.print("stage7")
    dbg.print("")
...
if __name__=='__main__':
    ...
    print("python run_stage7.py [mp4 file] [output folder prefix]")
    print("ex) python run_stage7.py input.mp4 out-")
    dbg = debug_string()
    argument = sys.argv
    if len(argument) > 2:
        ebsynth_utility_stage7(dbg, ("./", argument[1], '','','','',''), 1, "mp4", False, argument[2])
